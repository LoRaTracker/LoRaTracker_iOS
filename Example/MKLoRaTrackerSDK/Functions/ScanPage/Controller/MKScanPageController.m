...
- (void)connectDeviceWithModel:(MKTrackerModel *)trackerModel {
    ...
    [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
        ...
        if (ValidStr([[NSUserDefaults standardUserDefaults] objectForKey:@"local_passwordRecord"])) {
            textField.text = [[NSUserDefaults standardUserDefaults] objectForKey:@"local_passwordRecord"];
        }
...
- (void)connectDeviceWithTrackerModel:(MKTrackerModel *)trackerModel {
    ...
    [[MKDeviceTypeManager shared] connectTracker:trackerModel password:password sucBlock:^{
        [[MKHudManager share] hide];
        self.needScan = YES;
        [[NSUserDefaults standardUserDefaults] setObject:SafeStr(password) forKey:@"local_passwordRecord"];
